/*
Purpose: Attach formats associated with the baseline dataset to the baseline data

*/

libname library 'E:\Family Options\Data\01_BaselineData' ;
...
modify s01_base_vand_140117;
   ...
   format        L5 L5F.;
   format        L6 L6F.;
   format	 a1_cat a1catf.;
   format	ageatra_cat ageatra_catf.;
   format	fam_income_cat fam_income_catf.;
   format	edu_attain edu_attainf.;
   format 	num_adults_cat num_adults_catf.;
   format 	num_child_cat num_child_catf.;
   format	site_id2 site_id2f.;
   format 	ptsd ptsdf.;
   format	psych_distress psych_distressf.;
   format 	b1_cat b1_catf.;
   format 	race_cat race_catf.;
   format 	time_c1 time_c1f.;
   format 	age_c3 age_c3f.;
   format 	time_days time_days.;
   format 	time_d6 time_d6f.;
